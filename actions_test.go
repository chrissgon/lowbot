...
func TestActions_SetCustomActions(t *testing.T) {
	...
	SetCustomActions(ActionsMap{
		name: func(flow *Flow, channel IChannel, interaction Interaction) (bool, error) { return false, nil },
	})
...
// 	_, err := RunNextAction(nil, nil, Interaction{})
...
// 	_, err = RunNextAction(flow, nil, Interaction{})
...
// 	newInteraction, wait := action(interaction)
